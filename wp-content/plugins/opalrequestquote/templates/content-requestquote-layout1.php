...
?>
<div class="requestquote-form layout1">
    <div class="requestquote-header clearfix">
            <div class="requestquote-icon pull-left">
                <i class="fa fa-commenting-o" aria-hidden="true"></i>
            </div>
            <div class="requestquote-content">
    ...
    <div class='requestquote-content-form clearfix'>
        <form class="form-vertical requestquote_short_form" name="requestquote_short_form" method="post" action="<?php echo get_page_link($opalrequestquote_page); ?>">
            ...
            <div class="fleft">
                <button type="submit" class="btn btn-block"><?php esc_html_e('Lets Move', 'opalrequestquote');?></button>
