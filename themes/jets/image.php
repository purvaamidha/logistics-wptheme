	...
	?>
			<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
				...
				<div class="attachment">
					<?php jets_fnc_the_attached_image(); ?>
				</div><!-- .attachment -->
			...
			<nav id="image-navigation" class="navigation image-navigation">
				<div class="nav-links">
				<?php previous_image_link( false, '<div class="previous-image">' . esc_html__( 'Previous Image', 'jets' ) . '</div>' ); ?>
				<?php next_image_link( false, '<div class="next-image">' . esc_html__( 'Next Image', 'jets' ) . '</div>' ); ?>
				</div><!-- .nav-links -->
