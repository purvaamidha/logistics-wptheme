...
$jets_page_layouts = apply_filters( 'jets_fnc_get_archive_sidebar_configs', null );
	...
	<div class="row">
		...
		<div id="main-content" class="main-content col-xs-12 <?php echo esc_attr($jets_page_layouts['main']['class']); ?>">
			...
			<header class="archive-header">
				<h1 class="archive-title"><?php printf( esc_html__( 'Tag Archives: %s', 'jets' ), single_tag_title( '', false ) ); ?></h1>
