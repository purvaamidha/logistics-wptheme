...
$jets_page_layouts = apply_filters( 'jets_fnc_get_single_service_sidebar_configs', null );
				...
				<div id="content" class="site-content" role="main">
					<?php
						...
						while ( have_posts() ) : the_post();
							 echo Opalservice_Template_Loader::get_template_part( 'content-single-service' );
						endwhile;
					?>
				</div><!-- #content -->
			</div><!-- #primary -->
